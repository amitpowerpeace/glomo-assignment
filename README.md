How to run the sports poll application Following are the steps to run the application

This repo handles the UI for sports poll application.

# Running Locally

Install dependencies using `npm install`

To debug locally run: 'npm start'

Following are the URL to run the application.

	http://localhost:3000/
	http://localhost:3000/polls
	http://localhost:3000/polls/1003015194
	http://localhost:3000/login




Once you run the application using the npm start it will run this URL.This is the home page of the application.http://localhost:3000/

once you selecte the checkitout it will go through the created poll pages
	http://localhost:3000/polls
Into this pages all the data is comming from the json dynamically I have kept once object for the answer into the json.

once user click on the see the poll it will redirects to the URL 
	http://localhost:3000/polls/1003015194 which is display the poll for specific event.
  Here you can select the option to change the voting result .once user click onto the vote it will update the voting result and same data will be redirect to the chart.

Here once you go thorugh this URL 	http://localhost:3000/login it will go to the login page Here I only 
give the FaceBook login ,so once you use the facebook login it will show the username and picture of the profile and email.

Note : For the face book login please use the appId here,please change the appId of yours. 
        <FacebookLogin
        appId="2112400502353926" 
I am using redux-reduxthunk-reactrouter to develop the appplication,Actually I am planning to use the Full stack application and accroding I created the folder structure but due to festival and time constrain I developed front end only.but all the rest api there.
